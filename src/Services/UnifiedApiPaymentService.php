...
/**
 * Reads and creates payments, and reads payment operations, against the Unified API,
...
{
    // PAYMENT_PATH takes a %s id, for getPayment(); OPERATION_PATH takes a %s id, for
    // getOperation(); PAYMENTS_PATH is the plain collection endpoint createPayment() POSTs to.
    // Similar names, deliberately distinct constants.
