...
final class PaymentNotCapturableExceptionTest extends TestCase
{
    public function testExtendsPayplugException(): void
    {
        ...
        self::assertInstanceOf(PayplugException::class, new PaymentNotCapturableException());
    }

    public function testConstructorStoresMessageCodeAndPrevious(): void
    {
        $previous = new \Exception('previous');
        $exception = new PaymentNotCapturableException('Reference authorization not capturable.', 400, $previous);

        self::assertSame('Reference authorization not capturable.', $exception->getMessage());
